...
public:
    ...
    explicit Cube(const Texture *texture = nullptr) : VAO(0){
    ...
    Cube(const Texture *texture0, const Texture *texture1, const Texture *texture2, const Texture *texture3, const Texture *texture4, const Texture *texture5) : VAO(0){
        tex[0] = texture0;
        tex[1] = texture1;
        tex[2] = texture2;
        tex[3] = texture3;
