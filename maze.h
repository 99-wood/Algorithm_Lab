...
namespace maze{
    ...
    inline std::ostream &operator <<(std::ostream & os,const NodeType& nodeType){
        switch (nodeType)
        {
            case NodeType::G: return os<<'G';
            case NodeType::S: return os<<'S';
            case NodeType::E: return os<<'E';
            case NodeType::W: return os<<'W';
            case NodeType::R: return os<<' ';
            case NodeType::T: return os<<'T';
            case NodeType::L: return os<<'L';
            case NodeType::B: return os<<'B';
            default:          assert(0);
        }
        assert(0);
    }
